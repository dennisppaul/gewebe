package de.hfkbremen.gewebe.sandbox.sunflowapiapi;
...
public class P5SunflowAPIAPI extends PGraphics3D {
    ...
    protected de.hfkbremen.gewebe.sandbox.sunflowapiapi.ProcessingDisplay display;
    /* for conversion from processing */
    de.hfkbremen.gewebe.sandbox.sunflowapiapi.SunflowShader shader;
     ...
     */
    public void setImageBasedLight(String name,
                                   Vector3 center,
                                   Vector3 up,
                                   int samples,
                                   int lowSamples,
     ...
     */
    public void setSunSkyLight(String name, Vector3 up, Vector3 east, Vector3 direction, Color color, int samples,
                               float turbidity, boolean groundExtendSky) {
        sunflow.parameter("up", up);
        sunflow.parameter("east", east);
        sunflow.parameter("sundir", direction);
        sunflow.parameter("ground.color",
                          colorSpace,
                          color.getRed() / (float) 255,
                          color.getGreen() / (float) 255,
                          color.getBlue() / (float) 255);
    ...
    public void setAmbientOcclusionShader() {
        shader.setAmbientOcclusionShader(new Color(calcR, calcG, calcB),
                                         new Color(calcR * .25f, calcG * .25f, calcB * .25f)
                ,
                                         16,
                                         10);
    ...
    public void setGlassShader() {
        shader.setGlassShader(new Color(calcR, calcG, calcB),
                              2.5f,
                              3.0f,
                              new Color(calcR * .25f, calcG * .25f, calcB * .25f));
        //		save name for use with primitives
     ...
     */
    public void setUberShader(Color diffuse, Color specular, String diffuseTexture, String specularTexture,
                              float diffuseBlend, float specularBlend, float glossyness, int samples) {
        shader.setUberShader(diffuse, specular, diffuseTexture, specularTexture, diffuseBlend, specularBlend,
                             glossyness, samples);
        //		save name for use with primitives
        currShader = shader.currentName;
    }
     ...
     * @param texture    Path to texture file
     */
    public void setWardShader(Color diffuse,
                              Color specular,
                              float roughnessX,
                              float roughnessY,
                              int samples,
     ...
     */
    @Deprecated
    public void setAmbientOcclusionShader(String name,
                                          Color bright,
                                          Color dark,
                                          int samples,
                                          float maxDist,
     ...
     */
    @Deprecated
    public void setUberShader(String name,
                              Color diffuse,
                              Color specular,
     ...
     */
    @Deprecated
    public void setWardShader(String name, Color diffuse, Color specular, float roughnessX, float roughnessY,
                              int samples) {
     ...
     */
    public void drawBezierMesh(String name,
                               int subdivs,
                               boolean smooth,
                               boolean quads,
                               int nu,
    ...
    public void drawJulia(String name,
                          float x,
                          float y,
                          float z,
                          float size,
    ...
    public void drawSphereFlake(String name, float x, float y, float z, float size, float xRotation, float yRotation,
                                float zRotation,
    ...
    public void setAmbientOcclusionEngine(Color bright, Color dark, int samples, float maxDist) {
        ...
        sunflow.parameter("gi.ambocc.bright",
                          colorSpace,
    ...
    public void setFakeGIEngine(Vector3 up, Color sky, Color ground) {
        ...
        sunflow.parameter("gi.fake.ground",
                          colorSpace,
                          ground.getRed() / (float) 255,
                          ground.getGreen() / (float) 255,
                          ground.getBlue() / (float) 255);
    }
    ...
    public void setColorSpace(String theColorSpace) {
        if (theColorSpace == COLORSPACE_SRGB_NONLINEAR) {
    ...
    public void render() {
        ...
        display = new de.hfkbremen.gewebe.sandbox.sunflowapiapi.ProcessingDisplay(parent, this);
    ...
    public void setBasicScene(int sceneWidth, int sceneHeight) {
        ...
        this.setDirectionalLight("myDirectionalLight",
                                 new Point3(-2, 3, 0),
                                 new Vector3(0, 0, 0),
                                 3,
                                 new Color(1f, 0f, 0f));
...
//    }
    ...
    private void resetCamera() {
        ...
        if (cameraType == this.CAMERA_FISHEYE) {
            ...
            this.setThinlensCamera(currCamera,
                                   fov,
                                   aspect,
                                   shiftX,
                                   shiftY,

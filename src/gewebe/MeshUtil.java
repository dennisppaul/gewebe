...
public class MeshUtil {
    ...
    public static boolean isPointInsideMesh(ArrayList<gewebe.Triangle> pTriangles,
                                            PVector pRayOrigin,
                                            PVector pRayDirection) {
    ...
    public static int countRayTrianglesIntersections(ArrayList<gewebe.Triangle> pTriangles,
                                                     PVector pRayOrigin,
                                                     PVector pRayDirection) {
        int mResults = 0;
        for (Triangle t : pTriangles) {

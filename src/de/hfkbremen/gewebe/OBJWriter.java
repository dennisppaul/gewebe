...
public class OBJWriter extends PGraphics {
    ...
    public void setPath(String path) {
        ...
        if (mFile == null) {
            throw new RuntimeException("DXF export requires an absolute path " + "for the location of the output " +
                                       "mFile.");
        }
    }
...
*/
    ...
    */
    ...
    public void line_conversion_type(int pLineConversionMode) {
        mLineConversionMode = pLineConversionMode;
    }
    ...
    */
    ...
    protected void writeLine(int index0, int index1) {
        if (mLineConversionMode == LINE_CONVERSION_MODE_PLANE) {
            ...
            // @TODO implement cylinder conversion
        }
    }

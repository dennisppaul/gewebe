...
public class Mesh {
    ...
    public ArrayList<de.hfkbremen.gewebe.Triangle> triangles() {
        final ArrayList<de.hfkbremen.gewebe.Triangle> mTriangles = new ArrayList<>();
        int myVertexIndex = mDrawStart * mVertexComponentsCount;

        for (int i = 0; i < mDrawLength; i += 3) {
            de.hfkbremen.gewebe.Triangle t = new Triangle();
